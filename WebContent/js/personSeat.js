...
const activeSeat = function(e){
    ...
    if(current_person===0 || e.currentTarget.classList.contains("reserved") || e.currentTarget.classList.contains("no_select") || e.currentTarget.classList.contains("no_seat"))
    {
        return;
    }
