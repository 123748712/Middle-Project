...
<!-- 페이지 타이틀 -->
<h2 class="pageTitle">구매등급 비례 연간포인트 지급</h2>
<!-- //페이지 타이틀 -->

<!-- 여기부터 페이지 내용 -->
<div class="membershipAdmin">
	<table class="table table-striped text-center" id="msaTbl">
		<caption class="sr-only">구매등급 비례 연간포인트 지급 - ID, 회원명, 구매등급, 포인트 정보 제공</caption>
		<colgroup>
			<col style="width: 25%;">
			<col style="width: 25%;">
			<col style="width: 25%;">
