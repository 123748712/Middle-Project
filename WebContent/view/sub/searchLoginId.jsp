...
<div class="searchLoginId-form form-horizontal">
	<form action="searchLoginId.do" method="post" id="searchLoginIdfrm">
		<div class="form-group">
			...
			<div class="col-sm-9">
				<input type="text" id="searchName" placeholder="이름" class="form-control" name="searchName">
			</div>
		</div>
		...
		<div class="text-right">
			<input type="button" value="아이디찾기" class="btn btn-danger btn-block btn-submit" id="btn">
		</div>
	</form>
</div>
