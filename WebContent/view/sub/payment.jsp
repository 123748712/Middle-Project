...
<div class="boardWrap">
	<div id="brdModiForm">
		...
		<div class="bttn">
			<input type="button" id="ok_b" value="확인"
				class="btn btn-default btn-xs"> <input type="button" id="cancel_b" value="취소" class="btn btn-default btn-xs">
		</div>
	</div>
				...
				<div class="modal-body">
					<form>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea class="txt form-control" rows="5" cols="50" name="pay_sc_con" id="tta"></textarea>
								<br>
							</div>
						</div>
